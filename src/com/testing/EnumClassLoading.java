...
public class EnumClassLoading {
	public static void main(String[] args) {
		var component = CardComponent.TYPE;
		var logger = Logger.getLogger(EnumClassLoading.class.getName());
		try {
			Class<?> clazz = Class.forName("com.card.component." + component.getName() + "Component");
			Arrays.asList(clazz.getEnumConstants())
					.forEach(componentEnum -> logger.log(Level.INFO, componentEnum.toString()));
